        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <table align="center" boder="0" margin-top="50px">
                ...
                <!-- <tr style="font-size: 110%;">
                    ...
                    <td></td>
                    <td><input type="radio" name="rdo_phuongthucTT" value="Thanh toán online" id="ttTN">Thanh toán online</td>
                    <td></td>
                </tr> -->
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <img src="./upload/<?php echo $row['anhsanpham'] ?> " style="height:150px;" alt="">
                                </td>
                                <td><?php echo $row['tensp']; ?></td>
                                <td class="text-right"><?php echo number_format($row['giasanpham']); ?> VND</td>
                            </tr>
                        <?php
                        }
                        ?>
                ...
                <tr style="font-size: 110%;">
                    <!-- <td></td> -->
                    <td></td>
                    <td>Tổng Tiền: <?php echo number_format($row['giasanpham']); ?> VND
                    </td>
                    <td colspan="3" align="center" margin-top="20px">
                        <input type="submit" style="background-color: #726364; text-align: right;" value="Đặt hàng" name="datdonhang">
                ...
                <?php include('./giohang/xuly_dondathangngay.php');
                ?>
                <!-- nút -->
            </table>
        </form>
